    ...
    @isset($data)
        @foreach($data as $datum)
            <div class='mx-4'>
                ...
                <a class='btn btn-outline-primary btn-sm' href="{{ route('edit', ['datum_id'=>$datum->id, 'league'=>'laliga'] )}}">編集</a>
                <a class='btn btn-outline-danger btn-sm' href="{{ route('delete', ['datum_id'=>$datum->id, 'league'=>'laliga'])}}">削除</a>
                <hr>
            </div>
        @endforeach
    @endisset
